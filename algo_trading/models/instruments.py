...
class Instrument(models.Model):
    ...
    exchange_token = models.CharField(
        "zerodha exchange token", max_length=100, default=""
    )
    trading_symbol = models.CharField(
        "zerodha trading symbol", max_length=100, default=""
    )
    name = models.CharField(
        "zerodha company name", default=None, null=True, blank=True, max_length=100
    )
    expiry = models.CharField(
        "zerodha expiry date", default=None, null=True, blank=True, max_length=100
    )
    ...
    lot_size = models.IntegerField(
        "zerodha lot size", default=None, null=True, blank=True
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["instrument_type"], name="instrument_instrument_type_idx"
            ),
            models.Index(
                fields=["trading_symbol", "exchange"], name="instrument_identifier_idx"
            ),
        ]
